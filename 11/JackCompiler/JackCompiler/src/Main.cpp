...
int main(int argc, char* argv[])
{
    ...
    {
        std::cout << "Compiling " << absPathNoExt << ".vm ...\n";
        std::string jackSourceName = absPathNoExt + ".jack";
        std::string vmSourceName = absPathNoExt + ".vm";
        JackCompilationEngine compilationEngine(jackSourceName, vmSourceName);
